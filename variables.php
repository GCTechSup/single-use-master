 ...
 */	
 	...
 	define('PROTECTED_DOWNLOAD','secret/GHGCPattern1.exe');
	...
	define('SUGGESTED_FILENAME','Glendas Hooded Gypsy Cardigan.exe');
	
	// The admin password to generate a new download link
	define('ADMIN_PASSWORD','ThisIsMyPassword1234');
